<script setup lang="ts">
  import { avatarText, kFormatter } from '@utils/formatters';
    ...
    <VCol cols="12">
      <VCard>
        <VCardText class="d-flex">
          <!-- 👉 Standard Chip -->
          <VChip label color="primary" size="small"> Standard </VChip>
          ...
          <div class="d-flex align-center">
            ...
            <h3 class="text-h3 text-primary font-weight-semibold">99</h3>
            <sub class="mt-3"
        ...
        <VCardText>
          ...
          <div class="my-6">
            <div class="d-flex font-weight-semibold mt-3 mb-2">
              <h6 class="text-base font-weight-semibold">Days</h6>
              <VSpacer />
              <h6 class="text-base font-weight-semibold">26 of 30 Days</h6>
            </div>
